    ...
    <View style={styles.container}>
      ...
      <View style={styles.buttonsContainer}>
        <TouchableOpacity style={styles.nextBtn} onPress={goNext}>
          <Text style={styles.nextBtnText}>{isLast ? 'Bắt đầu ngay' : 'Tiếp theo'}</Text>
        ...
        {!isLast && (
          <TouchableOpacity style={styles.loginLinkBtn} onPress={goToAuth}>
            <Text style={styles.loginLinkText}>
              Đã có tài khoản? <Text style={styles.loginLinkAccent}>Đăng nhập ngay</Text>
            </Text>
          </TouchableOpacity>
        )}
      </View>
...
const styles = StyleSheet.create({
  ...
  textContainer: { alignItems: 'center', paddingHorizontal: 16, marginBottom: 40 },
  title: {
  ...
  dotsContainer: { flexDirection: 'row', alignItems: 'center', gap: 8, marginBottom: 48 },
