        ...
        <View style={styles.section}>
          ...
          <View style={styles.questionArea}>
            ...
            <View style={styles.toolbar}>
              <TouchableOpacity style={styles.toolBtn}><Text style={styles.toolBtnText}>B</Text></TouchableOpacity>
              <TouchableOpacity style={styles.toolBtn}><Text style={styles.toolBtnText}>I</Text></TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  toolBtnText: { fontSize: 14, fontWeight: '700', color: '#475569' },
  optionRow: {
    flexDirection: 'row',
