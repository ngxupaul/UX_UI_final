...
export const MOCK_QUESTIONS: MockQuestion[] = [
  ...
  },
  {
    ...
    subject: "Vật lý 12",
    content:
      "Trong dao động điều hòa, đại lượng nào luôn vuông pha với li độ?",
    options: ["Vận tốc", "Biên độ", "Chu kỳ", "Tần số"],
    correctIndex: 0,
  },
  {
    id: "q-3",
    ...
    subject: "Vật lý 12",
    content:
      "Nếu tăng tần số góc của dao động điều hòa lên 2 lần và giữ nguyên biên độ thì vận tốc cực đại sẽ thay đổi thế nào?",
    options: ["Giảm 2 lần", "Tăng 2 lần", "Không đổi", "Tăng 4 lần"],
    correctIndex: 1,
  },
  {
    id: "q-4",
    ...
    subject: "Vật lý 12",
    content:
      "Một con lắc lò xo dao động với biên độ 5 cm. Li độ cực đại của vật là bao nhiêu?",
  ...
  },
  {
    ...
    examId: "exam-2",
    subject: "Địa lý 6",
    content: "Châu lục nào có diện tích lớn nhất trên Trái Đất?",
  ...
  },
  {
    ...
    examId: "exam-2",
    subject: "Địa lý 6",
    content: "Kinh tuyến gốc đi qua thành phố nào?",
    options: ["Paris", "Greenwich", "London", "Rome"],
    correctIndex: 1,
  },
  {
    id: "q-8",
    examId: "exam-2",
    subject: "Địa lý 6",
    content: "Dạng địa hình nào thường có độ cao tuyệt đối dưới 200m?",
    options: ["Núi", "Cao nguyên", "Đồng bằng", "Sơn nguyên"],
    correctIndex: 2,
  },
];
